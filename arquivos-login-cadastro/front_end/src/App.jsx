...
function App() {
  ...
  const handleLogin = async ({ identifier, password }) => {
    ...
    try {
      ...
      setLoginSuccess('Entrada realizada com sucesso.')
      setToastMessage('Voce entrou na plataforma.')
    } catch (error) {
  ...
  const handleRegister = async ({ username, email, password, confirmPassword, role }) => {
    ...
    try {
      ...
      setRegisterError(error.message || 'Nao foi possivel criar sua conta. Verifique os dados e tente novamente.')
    }
  }
